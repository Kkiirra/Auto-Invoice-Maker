    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_creation', models.DateTimeField(default=django.utils.timezone.now, verbose_name='date_creation')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='customuser.customuser')),
            ],
            options={
